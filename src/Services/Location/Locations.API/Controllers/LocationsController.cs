...
namespace Locations.API.Controllers
{
    ...
    public class LocationsController : ControllerBase
    {
        ...
        [Route("")]
        [HttpGet]
        [ProducesResponseType(typeof(List<BolaRoja.Services.Locations.API.Model.Locations>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<List<BolaRoja.Services.Locations.API.Model.Locations>>> GetAllLocationsAsync()
        {
        ...
        [Route("{locationId}")]
        [HttpGet]
        [ProducesResponseType(typeof(BolaRoja.Services.Locations.API.Model.Locations), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<BolaRoja.Services.Locations.API.Model.Locations>> GetLocationAsync(int locationId)
        {
