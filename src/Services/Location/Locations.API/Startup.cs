...
using BolaRoja.BuildingBlocks.EventBus;
using BolaRoja.BuildingBlocks.EventBus.Abstractions;
using BolaRoja.BuildingBlocks.EventBusRabbitMQ;
using BolaRoja.BuildingBlocks.EventBusServiceBus;
using BolaRoja.Services.Locations.API.Infrastructure;
using BolaRoja.Services.Locations.API.Infrastructure.Filters;
using BolaRoja.Services.Locations.API.Infrastructure.Middlewares;
using BolaRoja.Services.Locations.API.Infrastructure.Repositories;
using BolaRoja.Services.Locations.API.Infrastructure.Services;
...
namespace BolaRoja.Services.Locations.API
{
