...
- Orders data (SQL Server): Server=tcp:localhost,5432;Database=BolaRoja.Services.OrderingDb;User Id=sa;Password=Pass@word;
- Catalog data (SQL Server): Server=tcp:localhost,5434;Database=CatalogDB;User Id=sa;Password=Pass@word
- Identity data (SQL Server): Server=localhost,5433;Database=aspnet-BolaRoja;User Id=sa;Password=Pass@word
